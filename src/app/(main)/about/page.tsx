  ...
  const informationPage: InformationType[] = [
    {
      ...
      customDetail: (
        <div className="mt-4 space-y-4">
          <p className="indent-8 text-muted-foreground text-base leading-relaxed whitespace-normal">
            ผมเป็น{" "}
            <span className="font-medium text-foreground">IT Specialist</span>{" "}
            ที่ได้รับมอบหมายให้พัฒนา{" "}
            <span className="font-medium text-foreground">Internal System</span>{" "}
            ภายในองค์กร มีประสบการณ์กว่า{" "}
            <span className="font-medium text-foreground">3 ปี</span> ในการแปลง{" "}
            ...
            จากผู้ใช้งานหน้างาน การออกแบบโครงสร้างระบบและฐานข้อมูล
          ...
          <p className="indent-8 text-muted-foreground text-base leading-relaxed">
            ...
            เป็นอย่างดี โดยเข้าใจ{" "}
            <span className="font-medium text-foreground">
              บทบาท หน้าที่ความรับผิดชอบ
            </span>{" "}
            และ{" "}
            <span className="font-medium text-foreground">
              ลำดับการส่งต่องานระหว่างแผนก
            </span>{" "}
            ต่าง ๆ ยกเว้นในส่วนของงานด้านบัญชี
            นอกจากนี้ยังมีประสบการณ์ในการใช้งาน{" "}
            <span className="font-medium text-foreground">
              SAP Business One
            </span>{" "}
            และสามารถดึงข้อมูลจาก SAP มาพัฒนาเป็น{" "}
            <span className="font-medium text-foreground">
              ระบบเสริม (Satellite System)
            </span>{" "}
            เพื่อเติมเต็ม Workflow ในส่วนที่ระบบ ERP หลักยังไม่ครอบคลุม
          </p>

          <p className="indent-8 text-muted-foreground text-base leading-relaxed">
            นอกเหนือจากการพัฒนาระบบด้วยตนเอง ผมยังมีประสบการณ์ในการทำหน้าที่เป็น{" "}
            <span className="font-medium text-foreground">
              ตัวกลางประสานงานโครงการ (Project Coordinator)
            </span>{" "}
            โดยรับผิดชอบการรวบรวมความต้องการจากผู้ใช้งาน สรุปออกมาเป็น{" "}
            <span className="font-medium text-foreground">
              Flow งานที่ชัดเจน
            </span>{" "}
